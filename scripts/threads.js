...
/* ---------- 발행 시각 ----------
   ...
   지금은 평일 2편입니다. **소재가 모자라서가 아니라 계정을 지키려고 정한 값입니다.**
   쓰레드는 계정 정지가 워낙 흔하고, 첫 계정도 하루 만에 그렇게 됐습니다.
   그래서 하루 2편을 상한으로 두고 그 아래에서만 씁니다.
   소재가 늘어도 이 값은 올리지 않습니다. 올릴 이유가 소재량이 아니기 때문입니다.
