---
title: 견적 발송 자동화, 하루에서 5분으로
date: 2026-08-02
description: 구글 워크스페이스를 메일함으로만 쓰던 회사가 앱스 스크립트로 견적 접수부터 PDF 발송까지 5분으로 줄인 과정입니다.
...
1. 고객이 구글 양식으로 견적을 요청합니다
2. 요청 내용이 구글 시트에 쌓입니다
3. 알림 메일이 옵니다
4. 사람이 메일을 열어 요청 내용을 파악합니다
5. 사람이 수동으로 견적을 작성합니다
6. 사람이 메일로 발송합니다
...
그런데 이 다음 항목에서 저는 [도구를 하나 더 들이게 됩니다](/posts/google-apps-script-to-n8n/). 잘 돌아가는 자동화를 그대로 두고 왜 그랬는지는 다음 글에 적겠습니다.
