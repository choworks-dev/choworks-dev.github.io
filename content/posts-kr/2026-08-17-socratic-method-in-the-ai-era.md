...
방식은 대체로 이렇게 흘러갑니다. 상대가 무언가를 안다고 말합니다. 용기가 무엇인지 안다, 정의가 무엇인지 안다. 소크라테스는 그러면 그것을 정의해 달라고 합니다. 상대가 정의를 내놓습니다. 소크라테스는 반박하지 않습니다. 대신 그 정의가 들어맞지 않는 경우를 하나 묻습니다. 상대가 정의를 고칩니다. 또 안 맞는 경우를 묻습니다. 이걸 몇 번 반복하면 상대는 자기가 그것을 몰랐다는 지점에 도착합니다. 이 상태를 아포리아, 막다른 길이라고 부릅니다.

여기서 끝이 아닙니다. 자기가 모른다는 것을 알게 된 사람만이 진짜로 묻기 시작합니다. 그 지점부터 대화는 답을 찾는 쪽으로 갑니다. 소크라테스는 이걸 산파술이라고 불렀습니다. 자기가 지식을 넣어 주는 게 아니라 상대 안에 있는 것을 밖으로 꺼내는 산파 역할이라는 뜻입니다.

플라톤의 대화편 메논에는 이걸 보여주는 장면이 있습니다. 기하학을 배운 적 없는 소년에게 소크라테스가 질문만 던집니다. 정사각형의 두 배 면적을 가진 정사각형을 어떻게 그리느냐. 소년은 처음에 변의 길이를 두 배로 하면 된다고 답합니다. 틀렸습니다. 소크라테스는 틀렸다고 말해주는 대신 그림을 그려 보게 하고 다시 묻습니다. 소년은 자기가 틀렸다는 것을 스스로 발견하고, 결국 대각선을 변으로 삼으면 된다는 답에 도달합니다. 소크라테스는 답을 알려준 적이 없습니다.
...
저는 이 조건 중 어느 것도 갖춘 적이 없습니다. 지방에서 작은 회사를 하고 있고, 옆에 물어볼 사람이 없어서 모르는 채로 넘긴 일이 수십 년치 쌓여 있었습니다.
